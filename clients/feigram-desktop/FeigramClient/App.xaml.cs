...
namespace FeigramClient
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            {
                client.BaseAddress = new Uri("https://10.50.49.14");
            })
            ...
            var channel = Grpc.Net.Client.GrpcChannel.ForAddress("https://10.50.49.14", new Grpc.Net.Client.GrpcChannelOptions
            {
